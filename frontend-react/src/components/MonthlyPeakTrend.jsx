...
const MonthlyPeakTrend = ({ darkMode }) => {
    return (
        <div className={`p-6 rounded-2xl border transition-all duration-300 ${darkMode ? 'bg-slate-800/40 backdrop-blur-md border-white/10 shadow-lg text-white' : 'bg-white border-gray-200 shadow-sm'}`}>
